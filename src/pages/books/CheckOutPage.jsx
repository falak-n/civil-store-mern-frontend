...
const CheckoutPage = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            console.log("Order Response:", response);  // Log the successful response
            Swal.fire({
            ...
            console.error("Error placing the order:", error);  // Log the full error response
            alert(`Failed to place an order. ${error?.data?.message || error.message}`);
        }
    }        
